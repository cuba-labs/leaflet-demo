...
public class LeafletdemoTestContainer extends TestContainer {

    public LeafletdemoTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/haulmont/demo/app.properties",
    ...
    public static class Common extends LeafletdemoTestContainer {

        public static final LeafletdemoTestContainer.Common INSTANCE = new LeafletdemoTestContainer.Common();
